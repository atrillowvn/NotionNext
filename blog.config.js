...
const BLOG = {
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://aibrad.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'EURO 2024,aibrad', // 网站关键词 英文逗号隔开
  ...
  POST_RECOMMEND_COUNT: process.env.NEXT_PUBLIC_POST_RECOMMEND_COUNT || 16, // 推荐文章数量
  ...
  ANALYTICS_51LA_ID: process.env.NEXT_PUBLIC_ANALYTICS_51LA_ID || '3Ix3kEzc6MMEoPcI', // id，在51la后台获取 参阅 https://docs.tangly1024.com/article/notion-next-51-la
  ANALYTICS_51LA_CK: process.env.NEXT_PUBLIC_ANALYTICS_51LA_CK || '3Ix3kEzc6MMEoPcI', // ck，在51la后台获取
  ...
  // 谷歌广告
  ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'pub-3200085150404604', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
